PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.ringtone_sim2=SlowGlow.WAV \
    ro.control_privapp_permissions=log \
    ro.custom.build.version=Primo_E9_SW_V1.6_21092018 \
    ...
    ro.nstart.add_cbmessage=true \
    ro.nstart.alarm.always=true \
    ro.nstart.alarm_snooze=10 \
    ro.nstart.alarm_timeout=10 \
    ro.nstart.bt_model=Primo__E9 \
    ro.nstart.call_auto_rec=true \
    ro.nstart.cam_shut_sound=on \
    ro.nstart.cam_video_focus=true \
    ro.nstart.camera_pic_ratio=1.3333 \
    ro.nstart.cbmsg_custom=Channel,50,true \
    ro.nstart.common.remove=true \
    ro.nstart.contact_showcount=true \
    ro.nstart.contact_speeddial=true \
    ro.nstart.custom_browser=true \
    ro.nstart.custom_emailsign=true \
    ro.nstart.customer.wlanSSID=Primo__E9 \
    ro.nstart.customer=WT \
    ro.nstart.date_format_def=dd-MM-yyyy \
    ro.nstart.def_brightness=255 \
    ro.nstart.dualsim_ringtone=true \
    ro.nstart.edit_img_remain_old=true \
    ro.nstart.fast_boot_off=true \
    ro.nstart.hide_onesim_notice=true \
    ro.nstart.ip_dial_menu=true \
    ro.nstart.launcher_menubg_alp=yes \
    ro.nstart.launcher_qsbar=true \
    ro.nstart.menu_recentapp=true \
    ro.nstart.misc_device_info=true \
    ro.nstart.more.ring=true \
    ro.nstart.music_prebutton=true \
    ro.nstart.music_seekbar=true \
    ro.nstart.project.name=G186_WT_E9 \
    ro.nstart.release.patch=alps-mp-o1.mp2 \
    ro.nstart.restore_def_ring=true \
    ro.nstart.set_network_style=true \
    ro.nstart.setting_no_force=true \
    ro.nstart.skip_setup_wizard=true \
    ro.nstart.sms_sales_track=true \
    ro.nstart.software_version=Primo_E9_SW_V1.6_21092018 \
    ro.nstart.status_bat_percent=true \
    ro.nstart.sync_ringtone_ui=true \
    ro.nstart.tee_google_key=true \
    ro.nstart.totalspace=yes \
    ro.nstart.unpinning_back=true \
    ro.nstart.usb_undef_charging=false \
    ro.nstart.wf_direct_name=Primo__E9 \
    ro.nstart.win_ani_off=true \
